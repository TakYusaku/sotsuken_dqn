...
def valid_selfPlay(fm,env,slp_num,main_n_1,main_n_2,target_n_1,target_n_2,memory_flame1_1,memory_flame1_2,info,actor_1,actor_2,no_counts_one,no_counts_two,no_counts_three,no_counts_four):
        print("selfplay : %d/10" %slp_num)
        selfplay = True
        Win_latest = 0
        Win_old = 0
        no_one = 0
        ...
        if float(Win_latest/100) >= 0.55:
            ...
            if Win_latest > Win_old:
                ...
                win = np.random.choice([0,1])
        return memory_flame1_1,memory_flame1_2,no_counts_one,no_counts_two,no_counts_three,no_counts_four,win,float(Win_latest/100)