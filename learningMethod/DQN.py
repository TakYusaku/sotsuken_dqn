...
def selfPlay(self,fm,env,slp_num,main_n_1,main_n_2,target_n_1,target_n_2,memory_flame1_1,memory_flame1_2,memory_state_1,memory_state_2,info,actor_1,actor_2,no_counts_one,no_counts_two,no_counts_three,no_counts_four):
    ...
    wins = [Win_latest,Win_old,Win_latest/100,Win_old/100]
    ts.Log(fm,'slp',wins,slp_num)
    main_n_1.plot_history(fm,i+1,'main_n1')
    main_n_2.plot_history(fm,i+1,'main_n2')
    target_n_1.plot_history(fm,i+1,'target_n1')
    target_n_2.plot_history(fm,i+1,'target_n2')
    main_n_1.save_weight(fm,i+1,'main_n1')
    main_n_2.save_weight(fm,i+1,'main_n2')
    target_n_1.save_weight(fm,i+1,'target_n1')
    target_n_2.save_weight(fm,i+1,'target_n2')

    if float(Win_latest/100) >= 0.55:
        win = 1
        return main_n_1,target_n_1,memory_flame1_1,memory_flame1_2,memory_state_1,memory_state_2,no_counts_one,no_counts_two,no_counts_three,no_counts_four,win
    elif float(Win_old/100) >= 0.55:
        win = 0
        return main_n_2,target_n_2,memory_flame1_1,memory_flame1_2,memory_state_1,memory_state_2,no_counts_one,no_counts_two,no_counts_three,no_counts_four,win
